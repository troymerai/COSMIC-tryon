...
class _ImagePickingScreenState extends State<ImagePickingScreen> {
  ...
  Future<void> _uploadImages() async {
    ...
    try {
      ...
      // 요청 정보 출력
      String fieldInfo = "{user_id: $userId}";
      String fileInfo =
          "body_image: ${_bodyImageFile!.path}, clothes_image: ${_clothesImageFile!.path}";
      Fluttertoast.showToast(msg: "Request Fields - $fieldInfo");
      Fluttertoast.showToast(msg: "Request Files - $fileInfo");

      //Fluttertoast.showToast(msg: '${jsonDecode(request.toString())}');
      ...
      body: ListView(
        children: [
          ...
          TextButton(
            ...
            child: Text('Select Clothes Image'),
          ),
          ElevatedButton(
